...
pug_html = pug_html + "\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cdiv ld=\"root\"\u003E\u003C\u002Fdiv\u003E";
...
pug_mixins["script"]("/assets/lib/@plotdb/csscope/dev/index.min.js");
pug_html = pug_html + "\u003Cscript type=\"module\"\u003Evar css;css=new csscope.manager;css.load(\"\u002Fcss\u002Fdev\u002Fsample.css\").then(function(s){console.log(s);return css.load(\"\u002Fcss\u002Fdev\u002Fsample.css\")}).then(function(s){return console.log(s)});\u003C\u002Fscript\u003E\u003C\u002Fbody\u003E\u003C\u002Fhtml\u003E";
